...
**Status:** v0 in progress. See [context-engineering/plans/](context-engineering/plans/) for the active implementation plan and [context-engineering/brainstorms/](context-engineering/brainstorms/) for the design doc.
...
- [context-engineering/](context-engineering/) — plans, brainstorms, reviews, learnings.
